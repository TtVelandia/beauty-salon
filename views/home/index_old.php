                ...
                <nav id="sidebarMenu" class="col-md-4 col-lg-3 d-md-block sidebar collapse p-0">
                    ...
                    <div class="position-sticky sidebar-sticky d-flex flex-column justify-content-center align-items-center">
                        ...
                        <ul class="nav flex-column">
                            ...
                            <li class="nav-item">
                                <a class="nav-link click-scroll" href="#section_2">Profesionales</a>
                            </li>
                ...
                <div class="col-md-8 ms-sm-auto col-lg-9 p-0">
                    <section class="hero-section d-flex justify-content-center align-items-center" id="section_1">
                            ...
                            <div class="container">
                                <div class="row">
                                    ...
                                    <div class="col-lg-8 col-12">
                                        <h1 class="text-white mb-lg-3 mb-4"><strong>TU SALÓN DE BELLEZA <em></em></strong></h1>
                                        <p class="text-black">Más cerca de ti, a solo un click</p>
                                        <br>
                            ...
                            <div class="custom-block d-lg-flex flex-column justify-content-center align-items-center">
                                ...
                                <h4><strong class="text-white">¡Apresurate! Nuestros profesionales te esperan .</strong></h4>

                                <a href="#booking-section" class="smoothscroll btn custom-btn custom-btn-italic mt-3">Agenda tu cita</a>
                            </div>
                    </section>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-12 col-12 mx-auto">
                                    ...
                                    <div class="border-bottom pb-3 mb-5">
                                        <p>Contamos con 3 profesionales quienes cuentan con más de cinco años de experiencia, brindando un <a href="https://templatemo.com/page/1" target="_blank">excelente servicio,</a> la satisfacción de nuestros clientes es nuestra prioridad .</p>
                                    </div>
                                </div>

                                    <h6 class="mb-5">Profesionales</h6>
                        ...
                        <div class="container">
                            <div class="row">
                                ...
                                <div class="col-lg-6 col-12 mb-4 mb-lg-0">
                                    <div class="services-thumb">
                                        <img src="assets/images/services/hairdresser-grooming-client.jpg" class="services-image img-fluid" alt="">
